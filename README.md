...
- [ ] **Phase 2: Multi-node Scale-out（Terraform）** （Coming Soon）
- [ ] **Phase 3: K8s etcd Guardian & DR Automation（Python）** （Coming Soon）
...
- **[02-k8s-scale-out-terraform/](./02-k8s-scale-out-terraform/)**: Multi-node Scale-out (Terraform)
  - Terraformを活用したインフラ拡張自動化
- **[03-k8s-etcd-guardian/](./03-k8s-etcd-guardian/)**: K8s etcd Guardian & DR Automation (Python)
  - Python SDKを用いたetcd Backup&Integrity及び復旧(DR)自動化
